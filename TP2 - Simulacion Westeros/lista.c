...
nodo_lista_t* crear_nodo(void* elemento){
    nodo_lista_t* nodo_nuevo = (nodo_lista_t*)calloc(1, sizeof(nodo_lista_t));
	if (!nodo_nuevo) {
		return NULL;
	}
...
int lista_insertar(lista_t* lista, void* elemento){
	...
	nodo_lista_t* nodo_nuevo = crear_nodo(elemento);
	if (!nodo_nuevo) {
		return ERROR;
	}
	if (lista->cantidad == 0){
...
int lista_insertar_en_posicion(lista_t* lista, void* elemento, size_t posicion){
	...
	if (posicion >= (lista->cantidad)) {
		...
		nodo_lista_t* nodo_actual = lista->nodo_inicio;
		int i = 0;
		while (i < posicion - 1) {
...
int lista_borrar(lista_t* lista){
	...
	nodo_lista_t* nodo_borrar= lista->nodo_fin;
...
void lista_borrar_inicio(lista_t* lista){
	nodo_lista_t* aux = lista->nodo_inicio;
...
int lista_borrar_de_posicion(lista_t* lista, size_t posicion){
	...
	if (posicion>= lista->cantidad) {
		...
		nodo_lista_t* nodo_borrar = nodo_actual->siguiente;
